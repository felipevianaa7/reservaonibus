async function listaReserva() {
    ...
    const conexao = await fetch("https://json-server-livid-omega.vercel.app/reservas");
...
async function apagaReserva(poltronas) {
    try {
        ...
        poltronasArray.forEach(async poltrona => {
            ...
            const endpoint = `https://json-server-livid-omega.vercel.app/reservas/${reservaEncontrada.id}`;
